...
class HomepageController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.pages.pagebuilder.home', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make(
            ...
            [
                ...
                'branner1' => 'required|image|mimes:png,jpg,jpeg|max:10000',
                'branner2' => 'required|image|mimes:png,jpg,jpeg|max:10000',
                'branner3' => 'required|image|mimes:png,jpg,jpeg|max:10000',
        ...
        if ($validator->passes()) {
            ...
            if (isset($bannerOneMainFile)) {
                $globalFunImgBannerOne = Helper::singleImageUpload($bannerOneMainFile, $uploadPath, 1672, 567);
            } else {
                $globalFunImgBannerOne = ['status' => 0];
            }

            if (isset($bannertwoMainFile)) {
                $globalFunBannerTwo = Helper::singleImageUpload($bannertwoMainFile, $uploadPath, 1672, 567);
            } else {
                $globalFunBannerTwo = ['status' => 0];
            }
            if (isset($bannerthreeMainFile)) {
                $globalFunBannerThree = Helper::singleImageUpload($bannerthreeMainFile, $uploadPath, 1672, 567);
            } else {
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.pagebuilder.homeEdit', $data);
    }
