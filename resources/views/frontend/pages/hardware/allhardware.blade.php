...
<div class="section_wp">
    ...
    <div class="container mb-5">
        ...
        <div class="nasted_tabbar_title">
            <h5>Category and Hardware Products List</h5>
            <p class="home_title_text">Explore our Hardware related products, categories and brands</p>
        </div>
        <div class="row tabbar_wrapper">
            <div class="col-4 m-0 p-0 text-center">
                <div class="tabbar_header_title">Hardware</div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody id="categoryTable">
                                    ...
                                    <tr class="p-1 text-center">
                                        ...
                                        <td class="p-1" width="20%">{{App\Models\Admin\Product::where('cat_id',$item->id)->where('product_type','hardware')->count()}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="col-lg-12">
                            <table class="table table-bordered">
                                ...
                                <tbody id="brandTable">
                                    ...
                                    <tr class="p-1 text-center">
                                        <td class="p-1" width="80%"><a href="{{route('custom.product',$item->slug)}}">{{$item->title}}</a></td>
                                        <td class="p-1" width="20%">{{App\Models\Admin\Product::where('brand_id',$item->id)->where('product_type','hardware')->count()}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
