        ...
        <div class="container-fluid">
            <div class="navbar-brand">
                <a href="index.html" class="d-inline-flex align-items-center">
                    <img src="{{ asset('backend') }}/assets/images/logo_icon.svg" alt="">
                    <img src="{{ asset('backend') }}/assets/images/logo_text_light.svg"
                                    ...
                                    <div class="card-body">
                                        <div class="text-center mb-3">
                                            <div
                                                ...
                                                <img src="{{ asset('backend') }}/assets/images/logo_icon.svg"
                                                    class="h-48px" alt="">
                                            </div>
                                        ...
                                        <div>
                                            <label class="form-check mb-2">
                                                <input type="checkbox" name="remember" class="form-check-input"
                                                    checked>
                                                <span class="form-check-label">Send me <a href="#">&nbsp;test
