                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <h4 class="mb-0 text-center">Add Client Story</h4>
                                </div>
                                <div class="col-lg-4">
                                    <a href="{{route('clientstory.index')}}" type="button" class="btn btn-sm btn-warning btn-labeled btn-labeled-start float-end">
