                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h2 class="mb-0 text-center">All Storys</h2>
                                </div>
                                <div class="col-lg-4">
                                    <a href="{{ route('clientstory.create') }}" type="button"
                        ...
                        <div class="card-body">
                            <table class="clientStoryDT datatable table table-bordered table-hover">
