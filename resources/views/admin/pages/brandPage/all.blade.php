                ...
                <div class="col-lg-12">
                    <div class="card mt-1">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h4 class="text-center">All Brand Page</h4>
                                </div>


                                <div class="col-lg-3">
                                    <a href="{{ route('brandPage.create') }}" type="button"
                                                    ...
                                                    @foreach ($brandPages as $key => $brandPage)
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><img
                                                                    src="{{ asset('storage/thumb/' . $brandPage->banner_image) }}"
                                                                    height="40" width="50" alt=""></td>
                                                            <td class="text-center"><img
                                                                    src="{{ asset('storage/thumb/' . $brandPage->row_six_image) }}"
                                                                    height="40" width="50" alt=""></td>
                                                            <td class="text-center">
                                                                <a href="{{ route('brandPage.edit', [$brandPage->id]) }}"
                                                                    class="text-primary">
