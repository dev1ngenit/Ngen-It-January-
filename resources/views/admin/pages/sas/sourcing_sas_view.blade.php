                                ...
                                <table class="text-center sasDT datatable table table-bordered table-hover">
                                    ...
                                    <tbody class="tb">
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%"><input type="number" class="result" readonly readonly value="">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%"><input class="result" type="number" readonly readonly value="">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%"><input class="multiplyValue"
                                                    readonly value="{{ $sourcing->sales_comission }}" type="number"
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%"><input class="multiplyValue"
                                                    readonly value="{{ $sourcing->regular_discounts }}" type="number"
