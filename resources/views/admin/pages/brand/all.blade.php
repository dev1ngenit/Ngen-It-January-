                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <a href="{{route('brand.create')}}" type="button" class="btn btn-sm btn-success btn-labeled btn-labeled-start float-end">
                        ...
                        <table class="datatable table table-bordered table-hover">
                            ...
                            <tbody>
                                @if ($brands)
                                    ...
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td class="text-center"><img  src="{{ asset('storage/requestImg/'.$brand->image) }}" height="30px" width="100px" alt=""></td>
                                        <td>{{$brand->title}}</td>
