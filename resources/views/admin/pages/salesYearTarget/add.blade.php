                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('salesYearTarget.store') }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="year_target" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="quarter_one_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="quarter_two_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="quarter_three_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="quarter_four_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="january_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="february_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="march_target" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="april_target" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="may_target" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="june_target" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="july_target" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="august_target" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="september_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="october_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="november_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="number" name="december_target"
                                                    class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row">
